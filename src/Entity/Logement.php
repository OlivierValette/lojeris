 ...
 * Logement
 *
 * @ORM\Table(name="logement", indexes={@ORM\Index(name="fk_logement_quartier1_idx", columns={"quartier_id"}), @ORM\Index(name="fk_logement_utilisateur1_idx", columns={"utilisateur_id"}), @ORM\Index(name="fk_logement_type_idx", columns={"type_id"})})
 * @ORM\Entity
 */
class Logement
{
